        ...
        for entry in self.hor:
            for column in [-1, 2]:
                for row in [-1, 0, 1]:
                    ...
                    if -1 < test_coord[0] < self.size[0] and -1 < test_coord[1] < self.size[1]:
                        print test_coord
                        if color == str(self.board[test_coord[0]][test_coord[1]]):
                            print "It matches!"
                            self.possible_moves_row.append(
                                [test_coord[0], test_coord[1], color])
            ...
            for row in [-1, 2]:
                for column in [-1, 0, 1]:
                    ...
                    if -1 < test_coord[0] < self.size[0] and -1 < test_coord[1] < self.size[1]:
                        ...
                        if color == str(self.board[test_coord[0]][test_coord[1]]):
                            print "It matches!"
                            self.possible_moves_column.append(
                                [test_coord[0], test_coord[1], color])
